...
# Polarity
predict(df, model,['pos_words','neg_words','pos_contrast','neg_contrast'],'Polarity' )
...
"""#All - Emotion
predict(df, model, ['pos_contrast','neg_contrast','strongsubj','weaksubj', 'valence_avg','arousal_avg','dominance_avg','valence_std','arousal_std','dominance_std','valence_max','arousal_max','dominance_max','valence_min','arousal_min','dominance_min','valence_dif','arousal_dif','dominance_dif', 'pos_words','neg_words', 'perceptuality','relativity','cognitivity','personal','biological','social'], 'All - Emotion')

#All - Subjectivity
predict(df, model, ['pos_contrast','neg_contrast','alegria','desgosto','medo','raiva','surpresa','tristeza', 'valence_avg','arousal_avg','dominance_avg','valence_std','arousal_std','dominance_std','valence_max','arousal_max','dominance_max','valence_min','arousal_min','dominance_min','valence_dif','arousal_dif','dominance_dif', 'pos_words','neg_words', 'perceptuality','relativity','cognitivity','personal','biological','social'], 'All - Subjectivity')

# All - Affective
predict(df, model, ['pos_contrast','neg_contrast','alegria','desgosto','medo','raiva','surpresa','tristeza', 'strongsubj','weaksubj', 'pos_words','neg_words', 'perceptuality','relativity','cognitivity','personal','biological','social'], 'All - Affectivity')
...
predict(df, model, [ 'valence_avg','arousal_avg','dominance_avg','valence_std','arousal_std','dominance_std','valence_max','arousal_max','dominance_max','valence_min','arousal_min','dominance_min','valence_dif','arousal_dif','dominance_dif', 'pos_words','neg_words','pos_contrast','neg_contrast'], 'All + Affectivity, polarity')
"""