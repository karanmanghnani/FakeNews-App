...
workbook = xlsxwriter.Workbook('BD_results_polarity2.xlsx')
...
worksheet.write(0, 8,"positive_contrast")
worksheet.write(0, 9,"negative_contrast")
worksheet.write(0, 10,"perceptuality")
worksheet.write(0, 11,"relativity")
worksheet.write(0, 12,"cognitivity")
worksheet.write(0, 13,"personal")
worksheet.write(0, 14,"biological")
worksheet.write(0, 15,"social")
...
for i in range(1,sheet.nrows):
	...
	worksheet.write(row, col, polarity['positive_contrast'])
	col+=1

	worksheet.write(row, col, polarity['negative_contrast'])
	col+=1
